...
function checkContactForm() {
  ...
  const validPhone = ph.replace(/\s/g, '').length >= 10;
...
function getPatientOverview(user) {
  ...
  <div class="dash-topbar">
    <div><img src="images/stackly-logo.png" alt="Stackly" style="height:28px;display:block;margin-bottom:6px;"><h2>My Health Dashboard</h2><p>${dateStr} — ${user.email}</p></div>
...
function getProviderOverview(user) {
  return `
  <div class="dash-topbar">
    <div><img src="images/stackly-logo.png" alt="Stackly" style="height:28px;display:block;margin-bottom:6px;"><h2>Provider Dashboard</h2><p>${user.email}</p></div>
    <!-- <div class="topbar-bell">🔔<span class="bell-dot"></span></div> -->
  </div>
